...
class AfrikaQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    val afrika = listOf<String>("Algerie", "Angola", "Benin", "Botswana", "Burkina Faso", "Burundi",
            "Kapp Verde", "Kamerun", "Den sentralafrikanske republikk", "Tsjad", "Komorene",
            "Kongo", "Den demokratiske republikken Kongo", "Elfenbenskysten", "Djibouti",
            "Ekvatorial-Guinea", "Eritrea", "Eswatini", "Etiopia", "Gabon", "Gambia", "Ghana", "Guinea",
            "Guinea-Bissau", "Kenya", "Lesotho", "Liberia", "Madagaskar", "Malawi", "Mali", "Mauritania",
            "Mauritius", "Marokko", "Mosambik", "Namibia", "Niger", "Nigeria",
            "Rwanda", "Sao Tome og Principe", "Senegal", "Seychellene", "Sierra Leone", "Somalia",
            "Sør-Afrika", "Sør-Sudan", "Tanzania", "Togo", "Tunisia", "Uganda", "Zambia", "Zimbabwe")

    var afrika_draw = mutableListOf<String>("Algeria", "Angola", "Benin", "Botswana", "Burkina_faso", "Burundi",
            "Cape_verde", "Cameroon", "Central_african_republic", "Chad", "Comoros",
            "Congo", "Democratic_republic_of_congo", "Cote_d_ivoire", "Djibouti",
            "Equatorial_guinea", "Eritrea", "Eswatini", "Ethiopia", "Gabon", "Gambia", "Ghana", "Guinea",
            "Guinea_bissau", "Kenya", "Lesotho", "Liberia", "Madagascar", "Malawi", "Mali", "Mauritania",
            "Mauritius", "Morocco", "Mozambique", "Namibia", "Niger", "Nigeria",
            "Rwanda", "Sao_tome_and_principe", "Senegal", "Seychelles", "Sierra_leone", "Somalia",
            "South_africa", "South_sudan", "Tanzania", "Togo", "Tunisia", "Uganda", "Zambia", "Zimbabwe")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in (0 until (afrika_draw.size))){
            afrika_draw[i] = afrika_draw[i].decapitalize()
            afrika_draw[i] = "flag_of_" + afrika_draw[i]
        }
    ...
    private fun submit(){
        if (mSelectedOptionPosition == 0){
            if (attempts == 0){
                MediaPlayer.create(this@AfrikaQuestionsActivity, R.raw.error).start()
            }else{
                mCurrentPosition += 1
                attempts = 0
            ...
            val wrong_music = listOf<MediaPlayer>(
                MediaPlayer.create(this@AfrikaQuestionsActivity, R.raw.thud),
                //MediaPlayer.create(this@AfrikaQuestionsActivity, R.raw.bruh),
                //MediaPlayer.create(this@AfrikaQuestionsActivity, R.raw.augh)
            )
            if (attempts < 1){
                if(question!!.correctAnswer != mSelectedOptionPosition){
                    ...
                    MediaPlayer.create(this@AfrikaQuestionsActivity, R.raw.correct).start()
                    mCorrectAnswers += 1
                }
    ...
    private fun getQuestions(): ArrayList<Question>{
        ...
        val flaggNavnList = afrika
        val drawNameList = afrika_draw
        var antall = 0
